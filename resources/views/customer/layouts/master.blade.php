...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('assets/customer/lib/owlcarousel/assets/owl.carousel.css') }}" rel="stylesheet">
    ...
    <scriscript      document.getElementById('currentYear').textContent = new Date().getFullYear();
    </script>
    </body>
</html>script